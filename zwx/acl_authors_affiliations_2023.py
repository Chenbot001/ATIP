...
def get_authors_and_affiliations(venue='2023.acl'):
    """
    获取指定会议的所有论文作者和机构信息
    
    参数:
        venue (str): 会议标识，默认为'2023.acl'
...
def save_results(authors_dict, affiliations_set, papers_info, output_dir="/Users/kele/实习/爬取/anthology/output"):
    ...
    authors_file = os.path.join(output_dir, 'acl2023_authors.csv')
    ...
    affiliations_file = os.path.join(output_dir, 'acl2023_affiliations.csv')
    ...
    papers_file = os.path.join(output_dir, 'acl2023_papers.csv')
...
def main():
    ...
    # 获取ACL 2023会议的作者和机构信息
    authors_dict, affiliations_set, papers_info = get_authors_and_affiliations('2023.acl')
